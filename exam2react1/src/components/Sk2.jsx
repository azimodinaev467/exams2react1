    ...
    return (
        <Box sx={{maxWidth:{xs:"400px", md:"1200px",sm:"1200px"}, margin:"auto", padding:2}}>
            <Box sx={{ display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between", padding: { xs: 1, md: 2 } , flexDirection:{xs:"column-reverse", md:"row", sm:"row"} }}>
                <Typography sx={{ fontSize: { xs: "14px", md: "50px" }, fontWeight: "bold", width: { xs: "400px", md: "700px" } }}>
                    Встречайте — скриншоты
                    и запись экрана 2 в 1
                </Typography>

                <Typography sx={{ fontSize: { xs: "14px", md: "15px" }, fontWeight: "bold", width: { xs: "400px", md: "700px" }, color:"#828282" }}>
                    Больше не нужно искать две отдельные программы
                    для скриншотов и записи экрана. Screenshoter поможет сделать снимок экрана, записать видео и поделиться им с кем угодно. Можно выделить весь экран, определенную область или активное окно
